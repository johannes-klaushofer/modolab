<?php
	...
	*/
	...
	function LOOPAdminTheme(){
		wp_enqueue_style('loop-admin-theme', plugins_url('css/wp-admin.css', __FILE__));
	}
	...
	function LOOPAdminThemeLogin(){
		echo '<link rel="stylesheet" type="text/css" href="'.plugins_url('css/wp-login.css', __FILE__).'" media="screen">';
	}
